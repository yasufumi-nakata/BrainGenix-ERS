...
namespace {
    ...
    void LoadRendererSettings(const YAML::Node& RendererSettingsNode, ERS_STRUCT_RendererSettings* RendererSettings) {
        ...
        if (RendererSettingsNode["RefreshStaticShadowMaps"]) {
            RendererSettings->RefreshStaticShadowMaps_ = RendererSettingsNode["RefreshStaticShadowMaps"].as<bool>();
        }
        if (RendererSettingsNode["MotionBlurEnabled"]) {
            RendererSettings->MotionBlurEnabled_ = RendererSettingsNode["MotionBlurEnabled"].as<bool>();
        }
        if (RendererSettingsNode["MotionBlurStrength"]) {
            RendererSettings->MotionBlurStrength_ = RendererSettingsNode["MotionBlurStrength"].as<float>();
        }
        if (RendererSettingsNode["MotionBlurReferenceFrameRate"]) {
            RendererSettings->MotionBlurReferenceFrameRate_ = RendererSettingsNode["MotionBlurReferenceFrameRate"].as<float>();
        }
        if (RendererSettingsNode["MotionBlurMaxBlend"]) {
            RendererSettings->MotionBlurMaxBlend_ = RendererSettingsNode["MotionBlurMaxBlend"].as<float>();
        }
